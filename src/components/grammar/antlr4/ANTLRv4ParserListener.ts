...
import { EndingContext } from "./ANTLRv4Parser";
...
export interface ANTLRv4ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `ANTLRv4Parser.ending`.
	 * @param ctx the parse tree
	 */
	enterEnding?: (ctx: EndingContext) => void;
	/**
	 * Exit a parse tree produced by `ANTLRv4Parser.ending`.
	 * @param ctx the parse tree
	 */
	exitEnding?: (ctx: EndingContext) => void;
